...
interface IEyeglassesFormProps extends FormComponentProps {
...
class EyeglassesForm extends PureComponent<IEyeglassesFormProps, FormState> {
  state: FormState = {
...
export default Form.create<IEyeglassesFormProps>()(EyeglassesForm);
